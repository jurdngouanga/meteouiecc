...
const apikey='6cd48d06a37e083e561d9401799239c5';
...
function weatherReport(data){
    ...
    fetch(urlcast).then((res)=>{
        ...
        document.getElementById('nuageux').innerText= data.weather[0].description;
...
function hourForecast(forecast){
    ...
    for (let i = 0; i < 5; i++) {
        ...
        hourR.setAttribute('class','prochain');
